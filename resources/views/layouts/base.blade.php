...
<head>
    <meta charset="utf-8">
    <title>NanoSoftwares - Online Service Provider for your House Needs</title>
    <meta name="keywords" content="">
    <meta name="description" content="">
    <meta name="author" content="">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <link rel="shortcut icon" href="{{ asset('assets/img/nanosoft.jfif') }}">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <ul class="visible-md visible-lg text-left">
                            <li><a href="tel:+911234567890"><i class="fa fa-phone"></i> 09157816443</a></li>
                            <li><a href="mailto:contact@surfsidemedia.in"><i class="fa fa-envelope"></i>
                                    nanosoftwares@gmail.com</a></li>
                        </ul>
                    ...
                    <div class="col-md-6">
                        <ul class="visible-md visible-lg text-right">
                            ...
                            <li><a href="index.php/changelocation.html"><i class="fa fa-map-marker"></i> Someware in Nigeria</a></li>
                        </ul>
                    </div>
                </div>
            </div>
